...
[abstract]
A description of the sections and properties defined in the sample connector config file, `$CBES_HOME/config/example-connector.toml`, followed by a description of the Consul configuration options specific to Autonomous Operations mode.
