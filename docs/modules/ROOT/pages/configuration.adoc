...
* Some configuration properties refer to filesystem locations.
If a relative path is provided, it will be resolved against the connector installation directory.
