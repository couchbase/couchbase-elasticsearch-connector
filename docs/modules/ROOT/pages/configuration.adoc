...
[couchbase]
  ...
  scope = '' <9>
  collections = ['myScope.widgets','myScope.invoices'] <10>
----
...
<9> (Since 4.2.3; Uncommitted) If you want to replicate from only one scope, name it here.
<10> (Since 4.2.3; Uncommitted) If you want to replicate from a subset of collections within a scope, or collections in different scopes, name the collections here.
