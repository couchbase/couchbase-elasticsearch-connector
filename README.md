...
**Important Note:** Due to changes in the Elasticsearch 2.x plugin architecture, each ES point release requires a different version of the Couchbase Transport Plugin. Please carefully consult the table below to make sure you get the right one for your ES release. 
...
Version Compatibility:
    ...
    +------------------------------------------------------------------+
    | 2.3.0  (placeholder)          |  2.5.x - 4.x  | 2.x              | 
    +------------------------------------------------------------------+
