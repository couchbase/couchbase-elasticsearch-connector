...
In order to install the plugin, download the zip file from the Downloads page, then run: 
    ...
    -url http://packages.couchbase.com.s3.amazonaws.com/releases/elastic-search-adapter/2.0.0/elasticsearch-transport-couchbase-2.0.0.zip
...
Version Compatibility:
    ...
    +------------------------------------------------------------------+
    | master                        |  3.x, 2.5.x   | 1.3.0 - 1.4.3    |
    +------------------------------------------------------------------+
    | 2.1                           |  3.x, 2.5.x   | 1.3.0 - 1.4.3    |
    +------------------------------------------------------------------+
    | 2.0                           |  3.x, 2.5.x   | 1.3.0            |
    +------------------------------------------------------------------+
    | 1.3.0                         |  2.5.x        | 1.1.0            |
